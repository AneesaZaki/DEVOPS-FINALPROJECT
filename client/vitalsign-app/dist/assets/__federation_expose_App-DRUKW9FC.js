...
const {useContext: useContext$7,useMemo: useMemo$2} = await importShared('react');
const DEFAULT_BREAKPOINTS = ['xxl', 'xl', 'lg', 'md', 'sm', 'xs'];
const DEFAULT_MIN_BREAKPOINT = 'xs';
const ThemeContext = /*#__PURE__*/React$k.createContext({
  prefixes: {},
...
function hasChildOfType(children, type) {
  return React$j.Children.toArray(children).some(child => /*#__PURE__*/React$j.isValidElement(child) && child.type === type);
}
...
const Col = /*#__PURE__*/React$i.forwardRef(
...
const Feedback = /*#__PURE__*/React$h.forwardRef(
// Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
({
  as: Component = 'div',
  className,
...
const FormContext = /*#__PURE__*/React$g.createContext({});
const FormContext$1 = FormContext;

const React$f = await importShared('react');

const {useContext: useContext$6} = await importShared('react');
const FormCheckInput = /*#__PURE__*/React$f.forwardRef(({
  id,
  bsPrefix,
  className,
  type = 'checkbox',
...
const FormCheckLabel = /*#__PURE__*/React$e.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
const FormCheck = /*#__PURE__*/React$d.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
const FormControl = /* @__PURE__ */ React$c.forwardRef(({
  bsPrefix,
  type,
  size,
  htmlSize,
...
const FormFloating = /*#__PURE__*/React$b.forwardRef(({
  className,
  bsPrefix,
  as: Component = 'div',
  ...props
...
const FormGroup = /*#__PURE__*/React$a.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'div',
  ...props
...
const FormLabel = /* @__PURE__ */ React$9.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = "label",
  bsPrefix,
  column = false,
...
const FormRange = /*#__PURE__*/React$8.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
const FormSelect = /*#__PURE__*/React$7.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
...
const FormText = /*#__PURE__*/React$6.forwardRef(
// Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
({
  bsPrefix,
  className,
...
const Switch = /*#__PURE__*/React$5.forwardRef((props, ref) => /*#__PURE__*/jsxRuntimeExports.jsx(FormCheck$1, {
  ...props,
  ref: ref,
  type: "switch"
}));
...
const FloatingLabel = /*#__PURE__*/React$4.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
const Form = /*#__PURE__*/React$3.forwardRef(({
  className,
  validated,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'form',
...
const Table = /*#__PURE__*/React$2.forwardRef(({
  bsPrefix,
  className,
  striped,
  bordered,
...
const {useQuery: useQuery$1} = await importShared('@apollo/client');

await importShared('react');
const VitalSign = () => {
  const { loading, error, data } = useQuery$1(VITAL_SIGNS);
  if (loading)
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/addVitalSign", className: "btn btn-primary mb-3", children: "Add Vital Sign" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Vital Signs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Table$1, { striped: true, bordered: true, hover: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Temperature" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Blood Pressure" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Heart Rate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Respiratory Rate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Action" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: data.vitalSigns && data.vitalSigns.map((vitalSign) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: vitalSign.temperature }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: vitalSign.bloodPressure }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: vitalSign.heartRate }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: vitalSign.respiratoryRate }),
...
const {useMutation,useQuery} = await importShared('@apollo/client');
...
const VitalSignForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    id ? handleUpdate(id, temperature, bloodPressure, heartRate, respiratoryRate) : handleAdd(
      temperature,
      bloodPressure,
      heartRate,
      respiratoryRate,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    id ? /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Edit Vital Sign" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Add Vital Sign" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: "Temperature" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: "Blood Pressure" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Form$1.Control,
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: "Heart Rate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Form$1.Control,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: "Respiratory Rate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Form$1.Control,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn btn-primary mt-3", children: "Submit" })
    ] })
  ] });
};
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "App", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ApolloProvider, { client, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(VitalSign, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/addVitalSign", element: /* @__PURE__ */ jsxRuntimeExports.jsx(VitalSignForm, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/edit/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(VitalSignForm, {}) })
  ] }) }) }) });
}
