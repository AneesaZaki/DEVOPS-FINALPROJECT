...
const {gql} = await importShared('@apollo/client');
...
const {useMutation} = await importShared('@apollo/client');
function UserComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { className: "p-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1, { onSubmit: handleSubmit, className: "mt-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "primary", type: "submit", disabled: isSubmitting, children: isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Spinner$1,
        {
          as: "span",
          animation: "border",
